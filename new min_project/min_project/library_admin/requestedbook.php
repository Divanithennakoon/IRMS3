...
<table class="my-table">
  ...
  <tbody>
  <?php
  $sql = "SELECT nic, username, Book_Name, Book_Id, Author, ISBN, Category, Year 
          FROM `request_book`  
  ...
  while($row = $result->fetch_assoc()){
    echo "<tr>
          ...
          <td>{$row['Year']}</td>
          <td>
              <a class='btn btn-issue' href='issuefunction.php?id={$row['Book_Id']}'onclick='return confirm(\"Are you sure you want to issue this book?\")'>Issue</a>
              <a class='btn btn-cancel' href='issuecancel.php?id={$row['Book_Id']}'onclick='return confirm(\"Are you sure you want to cancel this request?\")'>Cancel</a>
          </td>
        </tr>";
  }
?>
...
<div class="button-container">
    <a class="btn btn-see-all" href="allrequestedbooks.php">See All</a>
  </div>
